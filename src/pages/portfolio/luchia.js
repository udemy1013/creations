  ...
  >
    Next {">"}
        ...
        <Box sx={{textAlign: "center"}}>
            <Box component="img" src={luchiaImg1}/>
            <Box sx={{mt: 2}} component="img" src={luchiaImg2}/>
            <Box sx={{mt: 2}} component="img" src={luchiaImg3}/>
            <Box sx={{mt: 2}} component="img" src={luchiaImg4}/>
        </Box>
